...
<body>
    <form action = "../driverServletPamo" method ="post" onsubmit = "showAlert()">
        <div class="container">
            ...
            <label style = "color:blue;"><b>PILLO</b></label>
             <input type="checkbox" value = "Pamo" name = "driver" onchange ="limitToOne(this)" checked >
            <label style = "color:blue;"><b>PAMO</b></label>
             <input type="checkbox" value = "Zhokpo" name = "driver" onchange ="limitToOne(this)">
